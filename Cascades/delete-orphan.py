# if child is removed from parent it will automatically delete from db
...
class Parent(Base):
    ...
    children = relationship(  #relationship is used to link bet 2 tables 
        ...
        cascade="all,delete-orphan"  # add/update child automatically
    )
...
p3 = Parent(name="Parent3")
c3 = Child(name="Child3")
p3.children.append(c3)
session.add(p3)
session.commit()

# Remove child from parent
p3.children.remove(c3)
session.commit()  # c3 is deleted automatically
